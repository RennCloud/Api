<?php
    ...
    $address = "20.13.160.250"; //Server IP (If same server use localhost)

    $serverPort = 22; //SSH port (Default 22)
    
    $user = "RenxSsh"; //User for the server
    
    $password = "Rennxvps#123"; //Password for the server
    
    $Methods = array("NTP", "DNS", "HTTP", "stop"); //Array of methods

    $APIKey = "https://darlingapi.com/?key=YOURAPIKEY&host=$host&port=80&time=$time&method=$method&mode=$mode"; //Your API Key
